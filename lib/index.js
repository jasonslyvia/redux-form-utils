        ...
        case '@@form/VALUE_CHANGE':
          {
            ...
            return _extends({}, state, {
              form: _extends({}, state.form, _defineProperty({}, action.meta.field, _extends({}, state.form[action.meta.field], _defineProperty({}, '' + (fieldConfig.valueKey || 'value'), action.payload))))
            });
          }
        ...
        case '@@form/CLEAR_ALL':
          {
            return _extends({}, state, {
              form: Object.keys(state.form).reduce(function (prev, curr) {
                ...
                prev[curr] = _extends({}, state.form[curr], _defineProperty({}, '' + (fieldConfig.valueKey || 'value'), fieldConfig.initValue || ''));
        ...
        case '@@form/CLEAR':
          {
            ...
            return _extends({}, state, {
              form: _extends({}, state.form, _defineProperty({}, action.meta.field, _extends({}, state.form[action.meta.field], _defineProperty({}, '' + (fieldConfig.valueKey || 'value'), fieldConfig.initValue || ''))))
            });
          }
